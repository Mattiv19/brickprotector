            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        <Link href="/login">
                            <button className="text-black px-4 py-2 rounded-full text-sm font-medium hover:bg-blue-100 transition-colors hover:scale-105">
                                Log in
                            </button>
                        </Link>
                        <div>
                            <Link href="/cart">
                                <button className=" relative p-2 px-5 rounded-full hover:bg-blue-100 transition-all duration-200 transform hover:scale-110 group-hover:text-white">
