        ...
        <nav className="fixed w-full backdrop-blur-lg border-b border-white/10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between">
                    <div className="flex-shrink-0 pt-2 m-2 drop-shadow-md">
                        ...
                        <div className="flex items-center space-x-8">
                            {navLinks.map((link) => (
                                <Link
                                    key={link.name}
                                    href={link.href}
                                    className="text-navy-blue hover:text-gray-600 hover:border-b-2 hover:border-gray-600 px-3 py-2 text-sm font-medium drop-shadow-md"
                                >
                                    {link.name}
                                </Link>
                            ))}
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        <Link href="/login">
                            <button className="text-navy-blue px-4 py-2 rounded-full text-sm font-medium hover:bg-blue-100 transition-colors hover:scale-107 drop-shadow-md">
                                Log in
                            </button>
                        </Link>
                        <div>
                    ...
                    <div className="md:hidden">
                        <button
                            ...
                            className="inline-flex items-center justify-center p-2 rounded-md text-navy-blue hover:text-gray-600"
                        >
